  ...
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        ...
        tertiary: 'bg-secondary/70 text-secondary-foreground hover:bg-secondary/80',
        ghost: 'hover:bg-accent hover:text-accent-foreground',
        link: 'text-primary underline-offset-4 hover:underline',
        success: 'bg-emerald-200 text-emerald-800',
        primary: 'bg-customAccent text-white hover:bg-customAccent/90',
        discord: 'bg-service-discord text-white hover:bg-service-discord/90',
        twitch: 'bg-service-twitch text-white hover:bg-service-twitch/90',
      },
      size: {
        default: 'h-10 px-4 py-2',
        sm: 'h-9 rounded-md px-3',
        lg: 'h-11 rounded-md px-8',
        xl: 'h-[3.25rem] rounded-md px-4',
        icon: 'size-10',
      },
    },
    defaultVariants: {
