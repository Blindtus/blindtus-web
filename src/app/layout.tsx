...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const translations = {
    en: {
      ...
      description:
        'Challenge your knowledge of cinema and TV with Blindtus. Guess movies and TV shows by music, posters, or actors in our fun and interactive game modes: Blindtus, Pixelus, Castus, Hot Date and Title Twist!',
    },
    fr: {
      title: 'Blindtus - Le Jeu Ultime pour Deviner des Films et Séries',
      description:
        'Mettez à l’épreuve vos connaissances en cinéma et séries avec Blindtus. Devinez des films et séries grâce à la musique, aux affiches ou aux acteurs dans nos modes de jeu amusants et interactifs : Blindtus, Pixelus, Castus, Hot Date et Title Twist !',
    },
  };
