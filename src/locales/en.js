const translations = {
  ...
  "!text:suggest-description": [
    null,
    "Got a movie or TV show in mind that deserves a spot in our game? Share your favorites and help expand the challenge!"
  ],
  "!text:suggest-title": [
    null,
    "Lights, Camera… Suggest!"
  ],
  ...
  "!text:today-rules-blindtus-last-try": [
    null,
    "On your <b>last try</b>, you'll be presented with <b>{count} possible titles</b>—you must select the correct one."
  ],
